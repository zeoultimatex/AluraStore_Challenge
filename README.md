...
Este proyecto analiza datos de ventas de **4 tiendas distintas**, con el fin de extraer estadísticas e identificar patrones relevantes en las operaciones comerciales.
...
Con estos datos, se busca ofrecer una ayuda a la toma de decisiones para optimizar ventas, logística y satisfacción del cliente.
...
Ante cualquier duda, escribir directamente. ¡Exito! 😊
